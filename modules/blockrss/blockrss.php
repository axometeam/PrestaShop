...
class Blockrss extends Module
{
	...
	public static $xmlFields = array('title', 'guid', 'description', 'author', 'comments', 'pubDate', 'source', 'link', 'content');
	...
	function hookLeftColumn($params)
	{
		...
		$this->smarty->assign(
 	 	...
 	 	return $this->display(__FILE__, 'blockrss.tpl', $this->getCacheId());
 	}
